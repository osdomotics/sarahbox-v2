...
#networking
cp ./eth0 armstretchchroot/etc/network/interfaces.d/
...
cp ./osd.repository.key armstretchchroot/etc/apt/trusted.gpg.d/osd.gpg
...
cp ./boot-link armstretchchroot/etc/kernel/postinst.d/
